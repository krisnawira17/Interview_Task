          ...
          >
            <div className="flex flex-col p-4 bg-white drop-shadow-2xl">
              ...
              <input
                name="nama"
                id="nama"
                className="w-full border-b focus:outline-none border-black mb-4"
            ...
            <div className="flex flex-row justify-between gap-2 mt-2">
              <button className="border border-red-500 rounded-md p-2 w-full cursor-pointer text-red-500">
                BACK
              </button>
              <button className="border border-blue-400 bg-blue-400 rounded-md  p-2 w-full cursor-pointer text-white">
                SUBMIT
              </button>
            </div>
          </form>
